   ...
   createGraph() {
      ...
      const data: Data = {
         nodes: [
            ...
            { id: 18, group: 'grp5', radius: 3 },
            { id: 19, group: 'grp5', radius: 5 },
            { id: 20, group: 'grp5', radius: 8 },
         ],
         links: [
            { source: 1, target: 2, width: 2 },
            { source: 17, target: 2, width: 2 },
            { source: 14, target: 2, width: 2 },
            ...
            { source: 16, target: 19, width: 2 },
            { source: 10, target: 17, width: 9 },
            ...
            { source: 4, target: 8, width: 5 },
            { source: 18, target: 19, width: 5 },
            { source: 20, target: 19, width: 5 },
            { source: 20, target: 18, width: 5 },
            { source: 20, target: 2, width: 5 },
            { source: 18, target: 14, width: 5 },
            { source: 15, target: 8, width: 8 },
            { source: 15, target: 0, width: 5 },
         ],
      }
      //#endregion
